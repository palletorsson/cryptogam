...
var modelIndex = [  "marvelBlackWidowFanart",  "nudeMan", "starGuardian", "latexKnight",
                    "fanartFeliciaDarkstalkers", "firy", "octaviaDivaTPose",
                    "kimono", "candleman", "alitaBattleAngel",
                    "magicalCharm",  "sleepTight",
                     "discoveryInPink",
                    "characterFemale", "femaleScanSonyaCorset", "songokuScan",
                    "sciFiFemale",
                     "matteo",  "venom",
                    "knight5",  "sciFiNinjaPbr", "ironBladeHellforgedArmor",
                    "falcon1m", "namiFinalVersion", "darthVader","irenaZajtseva",
                    "swimming", "dungeonmakerEmma", "vaseFromParkInKonopisteChateau", "tsubaki",
                    "ashantiDanceHall", "asley",  "3dScanMan", "theCreatureOfTheLabyrinth",
                    "proceduralHardSurfaceModelingTest", "tsubakiMkIiobj","gwenStacy", "skytree",
                     "futurePoliceKnight", "maliakaZsketch", "babyShark","mythCreatureRound",
                    "marvelBlackWidowFanart", "HeavyBlasterGun", "ashantiDanceHall", "fantasyHordeOgres", "tariaGameCharacter", "darkMage",  "enemyNpc", "mountainKing",]
// ###  "corsetGirl",
// INSP: "bowsette", "annisaNude",
var allModels = {
    "models": {
            ...
            "events": [
                    {
                        ...
                        "event": "fadein",
                        "duration": "slow",
                        "position": [0.1752663936458515,-1.7210675619625706,77.51136169862272],
                        "target": [0.16372627847387053,-1.6375516235740963,72.14449578125621],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "duration": "slow",
                        "position": [0.312938876223953,-1.4005115838827458,54.31413041092428],
                        "target": [0.3129474052325557,-1.4005053673447045,54.31403096943059],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "duration": "slow",
            ...
            "events": [
                    {
                        "event": "fadein",
                        "duration": "slow",
                        "position": [5.309163946141236,-0.6823018024653851,181.3535537641804],
                        "target": [-6.024940888537358,-2.679587858588053,162.9029916944],
                        "duration": 0.05
                    },{
                        "event": "fadein",
                        "duration": "slow",
                        ...
                        "event": "fadein",
                        "duration": "slow",
                        "position": [2.499082912119227,-393.2772553661348,489.32459379040165],
                        "target": [0.0021218654463480238,-281.2347632759223,583.1335854935478],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "duration": "slow",
            ...
            "events": [
                    {
                        "event": "fadein",
                        "duration": "slow",
                        "position": [2.373224296073233,-7.510552333472669,-12.989755682998666],
                        "target": [0.9185240175731831,-2.4913631793040114,-12.241213409877735],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "position": [2.373224296073233,-7.510552333472669,-12.989755682998666],
                        ...
                        "event": "fadein",
                        "position": [2.1016149120556595,-6.897825541031301,-13.028306901130598],
                        "target": [2.0945291677694446,-6.87796749602059,-14.37046777401689],
                        "duration": 2.0
                    },{
                        "event": "fadein",
                        "position": [2.373224296073233,-7.510552333472669,-12.989755682998666],
                        ...
                        "event": "fadein",
                        "position": [1.6610919411690812,-4.758806896453689,-11.781393879284769],
                        "target": [1.1817208045364571,-2.6156716097695734,-11.309911226105111],
                        "duration": 4.0
                    },{
                        "event": "fadein",
                        "position": [0.21573955814191847,-3.325285135188394,-11.669324411236916],
                        "target": [0.4411534388488445,-3.224482237428839,-11.413762062680822],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "position": [0.21573955814191847,-3.325285135188394,-11.669324411236916],
                        ...
                        "event": "fadein",
                        "position": [2.025881255506742,-4.846658500721052,-13.080024096368467],
                        "target": [1.2921392131399054,-2.3143355052389203,-12.702413115487476],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "duration": "slow",
                        "position": [0.9604675687714571,-3.2947584674242707,-12.016587930810598],
                        "target": [0.9441072250393311,-3.2873460500062293,-10.87323634106078],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "duration": "slow",
                        "position": [0.8702438659468065,-3.6102545866051092,-11.168330109153558],
                        "target": [0.9441072250393311,-3.2873460500062293,-10.87323634106078],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "duration": "slow",
                        "position": [2.1942119049558686,-2.8021872450633145,-10.448693387524788],
                        "target": [2.026924800635148,-2.2707967846913517,-10.086855851043282],
                        "duration": 10.0
                    },{
                        "event": "fadein",
                        "duration": "slow",
...
success = function(callback) {
  ...
  //  api.addEventListener( 'viewerready', function() {
    ...
    api.addEventListener(
        ...
        function(info) {
          if (autom == false) {
            if ((info.position2D[0] + info.position2D[1]) < 40)  {
              eventColletedAutomatic()
              autom = true
            } else {
...
function eventColletedAutomatic() {
  ...
  console.log(currentEvent.position, currentEvent.duration, eventIndex);
  stopEvent = true;
  setTimeout(function() {
      eventIndex++;
      stopEvent = false;
